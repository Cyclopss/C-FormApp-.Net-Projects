...
namespace StartMenu
{
    public partial class tictactoe : Form
    {
        ...
        void Score()
        {
            ...
            {
                tic1Btn.BackColor = Color.LightGreen;
                tic2Btn.BackColor = Color.LightGreen;
                tic3Btn.BackColor = Color.LightGreen;
            ...
            {
                tic1Btn.BackColor = Color.LightGreen;
                tic4Btn.BackColor = Color.LightGreen;
                tic7Btn.BackColor = Color.LightGreen;
            ...
            {
                tic1Btn.BackColor = Color.LightGreen;
                tic5Btn.BackColor = Color.LightGreen;
                tic9Btn.BackColor = Color.LightGreen;
            ...
            if (tic2Btn.Text == "X" && tic5Btn.Text == "X" && tic8Btn.Text == "X")
            {
                tic2Btn.BackColor = Color.LightGreen;
                tic5Btn.BackColor = Color.LightGreen;
                tic8Btn.BackColor = Color.LightGreen;
            ...
            {
                tic3Btn.BackColor = Color.LightGreen;
                tic6Btn.BackColor = Color.LightGreen;
                tic9Btn.BackColor = Color.LightGreen;
